...
public class HDFCEMI extends IOBEMI {
	void run() {
		System.out.println("MONTH           Interest");
		System.out.println("6  MONTH           7%");
		System.out.println("12 MONTH           14%");
		...
		do {
			...
			switch(option) {
			case 1:
				double interest_principle = principle_Amount*0.07d;
			...
			case 2:
				double interest_principle1 = principle_Amount*0.14d;
