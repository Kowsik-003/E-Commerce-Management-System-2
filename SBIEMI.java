...
public class SBIEMI {
	void run2() {
		...
		System.out.println("6  MONTH           NO COST EMI");
		System.out.println("12 MONTH           NO COST EMI");
		...
		do {
			...
			switch(option) {
			case 1:
				double interest_principle = principle_Amount*0d;
			...
			case 2:
				double interest_principle1 = principle_Amount*0d;
